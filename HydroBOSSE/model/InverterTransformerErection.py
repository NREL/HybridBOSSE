...
class InverterTransformerErection(CostModule):
    ...
    def calculate_invertertransformer_erection_cost(self):
        """
        ...
        usacost["pct_ite"] = usacost["%ICC(inFC)"] * usacost["InverterTransformer Erection"]

        total_cost_percent = usacost.sum(axis=0)["pct_ite"]/100

        self.output_dict['invertertransformer_erection_cost'] = total_cost_percent * \
                                                                self.output_dict['total_initial_capital_cost']

        return self.output_dict['invertertransformer_erection_cost']
    ...
    def run_module(self):
        ...
        try:
            ...
            self.output_dict['total_erection_cost'] = self.calculate_invertertransformer_erection_cost()
