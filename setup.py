...
setup(
    ...
    packages=['hybrids_shared_infrastructure', 'LandBOSSE', 'LandBOSSE.landbosse.model',
              'LandBOSSE.landbosse.excelio','LandBOSSE.landbosse.tests',
              'LandBOSSE.landbosse.landbosse_api', 'SolarBOSSE', 'SolarBOSSE.excelio',
              'SolarBOSSE.model', 'SolarBOSSE.project_data'],
