...
def run_landbosse(input_dict):
    ...
    for key, _ in input_dict.items():
        ...
        elif key == 'override_total_management_cost':
            master_input_dict['override_total_management_cost'] = input_dict['override_total_management_cost']
...
# input_dict['path_to_project_list'] = '/Users/pbhaskar/Desktop/Projects/Shared Infrastructure/hybrids_shared_infra_tool/'
# input_dict['name_of_project_list'] = 'project_list_ copy'
