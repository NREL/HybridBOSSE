import os
import pandas as pd
from hybridbosse.StorageBOSSE.excelio.create_master_input_dict import XlsxReader
from hybridbosse.LandBOSSE.landbosse.excelio.XlsxDataframeCache import XlsxDataframeCache
from hybridbosse.StorageBOSSE.model.Manager import Manager as StorageManager
import xlsxwriter
from openpyxl import load_workbook

def run_storagebosse(input_dictionary):
    input_output_path = os.path.dirname(__file__)
    # if "path_to_project_list" in input_dictionary:
    #     input_output_path = input_dictionary["path_to_project_list"]
...
# <><><><><><><><> SIMPLEST EXAMPLE OF RUNNING THIS StorageBOSSE <><><><><><><><><><><>
...
# print("<><><><><><><><><><><><><><><><><><><>")
# print("Total:", BOS_results["total_cost"])
# for key, value in BOS_results.items():
#     print(key, value)
# print("<>")
# for key, value in detailed_results.items():
#     print(key, type(value))

# <><><><><><><><> END SIMPLEST EXAMPLE OF RUNNING THIS StorageBOSSE <><><><><><><><><><><>

# <><><><><><><><> RUNS LOOPING THROUGH VARIOUS PROJECT SIZES <><><><><><><><><><><>
...
# <><><><><><><><> END RUNS LOOPING THROUGH VARIOUS PROJECT SIZES <><><><><><><><><><><>



# <><><><><><><><> RUNS LOOPING THROUGH VARIOUS MATERIAL COST MULITPLIERS <><><><><><><><><><><>
# energies = 100
# powers = 100
# input_dict = dict()
# BOS_results = dict()
...
#     BOS_results = dict()
#     BOS_results.update({'Material Cost Multiplier': str(i)})
#     input_dict['system_size_MW_DC'] = powers
#     input_dict['system_size_MWh'] = energies
#     input_dict['site_prep_area_m2'] = 100*max(energies, powers) + 100
#     input_dict['project_list'] = 'project_list_test'
#     BOS_results, detailed_results = run_storagebosse(input_dict)
#     res.append(BOS_results['total_cost'])
#
# print(res)
#
#     """ OUTPUT TO EXCEL FOR TESTING"""
...
#     sheet.append(values)
#     book.save(filename=outfile)
# <><><><><><><><> END RUNS LOOPING THROUGH VARIOUS MATERIAL COST MULITPLIERS <><><><><><><><><><><>
