...
#        incomplete_input_dict['lcmcosts'] = lcmcosts_df
        ...
        #
        # if 'usacost_df' in project_data_dataframes:
        #     incomplete_input_dict['usacost'] = \
        #         project_data_dataframes['usacost']
        #
        # if 'lcmcosts_df' in project_data_dataframes:
        #     incomplete_input_dict['lcmcosts'] = \
        #         project_data_dataframes['lcmcosts']
        #
        #
        ...
        incomplete_input_dict['system_size_MW_DC'] = \
            project_parameters['Capacity MW']
