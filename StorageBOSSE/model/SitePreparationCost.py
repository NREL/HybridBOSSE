    ...
    **Keys in the output dictionary are the following:**
    ...
    def calculate_road_properties(self, input_dict, output_dict):
        ...
        float road_thickness_m
            Road thickness in meters

        float road_width_m
            Road width in meters

        float distance_to_substation
            Road distance to substation
        ...
        output_dict['crane_path_width_m'] = input_dict['crane_width_m'] + 1.5

        output_dict['road_thickness'] = input_dict['road_thickness_m']
        output_dict['road_width'] = input_dict['road_width_m']
    ...
    def estimate_construction_time(self, input_dict, output_dict):
        ...
        output_dict['embankment_volume_road'] = \
            ...
            math.ceil(output_dict['road_thickness'] / self._lift_depth_m)

        # here 10.76391 sq ft = 1 sq m
        output_dict['rough_grading_area'] = \
            (output_dict['site_prep_area_m2'] * 10.76391) / 100000
    ...
    def calculate_costs(self, input_dict, output_dict):
        ...
        equipment_data = labor_equip_data[
            labor_equip_data['Module'] == 'Roads (Storage)'].copy()
